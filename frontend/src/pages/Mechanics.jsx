...
export default function Mechanics() {
    return (
        <SiteLayout>
            <Seo
                title="Mechanics"
                description="Every action in Erchis resolves on one weighted d6 across six outcomes. Turn-based combat, eleven masteries with their own resources, crafting, guilds and status effects."
                path="/mechanics"
            />
