    ...
    return (
        <SiteLayout>
            <div className="max-w-3xl mx-auto px-4 md:px-6 py-12">
                ...
                <h1 className="font-pixel text-4xl md:text-5xl uppercase text-primary tracking-wider mb-6">About Erchis</h1>

                <div className="space-y-6">
                    <div className="panel p-6">
                        <h2 className="font-pixel text-xl uppercase text-primary mb-3">What is Erchis?</h2>
                        <p className="narr text-sm text-foreground/85 leading-relaxed">
                    ...
                    <div className="panel p-6">
                        <h2 className="font-pixel text-xl uppercase text-primary mb-3">Tech Stack</h2>
                    ...
                    <div className="panel p-6">
                        <h2 className="font-pixel text-xl uppercase text-primary mb-3">Roadmap</h2>
                        <div className="space-y-3">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-muted-foreground">Treasury-funded server-wide buffs for guild members.</div>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Zap size={14} className="text-primary mt-1" />
                                <div>
                                    ...
                                    <div className="text-sm text-muted-foreground">Devlogs, lore entries, patch notes, and community guides.</div>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Zap size={14} className="text-primary mt-1" />
                                <div>
                                    ...
                                    <div className="text-sm text-muted-foreground">Challenge other players in ranked dice combat.</div>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Zap size={14} className="text-primary mt-1" />
                                <div>
                                    ...
                                    <div className="text-sm text-muted-foreground">Send parties on timed missions for rare rewards.</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="panel p-6">
                        <h2 className="font-pixel text-xl uppercase text-primary mb-3">Community</h2>
                        <div className="flex gap-3 flex-wrap">
                            <Link to="/blog" className="press-btn stat-label px-4 py-2 border border-border text-muted-foreground hover:text-primary hover:border-primary flex items-center gap-2">
                                <Newspaper size={14} /> Blog
                            </Link>
                            <Link to="/changelog" className="press-btn stat-label px-4 py-2 border border-border text-muted-foreground hover:text-primary hover:border-primary flex items-center gap-2">
                ...
                <div className="mt-12 text-center border-t border-border pt-8">
                    <p className="narr text-sm text-muted-foreground">
