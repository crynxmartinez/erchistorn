...
export const metadata = {
    title: "About",
    description:
        "Erchis is a free browser fantasy RPG where one weighted six-sided die decides everything. Built by a solo developer — what it is, how it plays, and where it is going.",
            ...
            <Section variant="inset" label="Who builds it">
                ...
                <div className="mt-10 max-w-prose space-y-5 text-body text-foreground/85">
                    ...
                    <p>
                        ...
                        <Link href="/changelog">changelog</Link> is the whole history, including the
                        embarrassing parts.
                    </p>
                    <p>
