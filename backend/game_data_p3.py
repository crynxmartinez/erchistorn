...
EXTRA_ITEMS: list[dict] = [
    ...
    {"id": "basalt_axe",      "name": "Basalt War-Axe",  "rarity": "uncommon", "kind": "weapon", "power": 8,  "slot": "right_hand"},
    {"id": "cursed_blade",    "name": "Cursed Blade",    "rarity": "rare",     "kind": "weapon", "power": 12, "slot": "right_hand"},
    {"id": "cold_iron_spear", "name": "Cold Iron Spear", "rarity": "rare",     "kind": "weapon", "power": 15, "slot": "right_hand"},
    {"id": "storm_bow",       "name": "Storm Bow",       "rarity": "epic",     "kind": "weapon", "power": 20, "slot": "right_hand", "two_handed": True},
    {"id": "djinn_scimitar",  "name": "Djinn Scimitar",  "rarity": "epic",     "kind": "weapon", "power": 24, "slot": "right_hand"},
    {"id": "sylvan_glaive",   "name": "Sylvan Glaive",   "rarity": "legendary","kind": "weapon", "power": 30, "slot": "right_hand", "two_handed": True},
    {"id": "ashplate",        "name": "Ashplate",        "rarity": "uncommon", "kind": "armor",  "power": 6,  "slot": "body"},
    {"id": "mourncloak",      "name": "Mourncloak",      "rarity": "rare",     "kind": "armor",  "power": 9,  "slot": "back"},
    {"id": "jahra_hauberk",   "name": "Jahra Hauberk",   "rarity": "rare",     "kind": "armor",  "power": 12, "slot": "body"},
    {"id": "sky_mantle",      "name": "Sky Mantle",      "rarity": "epic",     "kind": "armor",  "power": 16, "slot": "back"},
    {"id": "sunveil_robe",    "name": "Sunveil Robe",    "rarity": "epic",     "kind": "armor",  "power": 20, "slot": "body"},
    {"id": "coral_platemail", "name": "Coral Platemail", "rarity": "legendary","kind": "armor",  "power": 26, "slot": "body"},
...
EXTRA_MONSTERS: list[dict] = [
    # ================ VULKAROS (Lv 8+) ================
    # ashlands
    {"id": "ash_hound",         "name": "Ash Hound",         "biome": "ashlands",      "power": 11, "hp": 55,
     "drops": [("ash_grass", 0.5), ("wolf_pelt", 0.5), ("basalt_shard", 0.3)]},
    {"id": "orc_grunt",         "name": "Orc Grunt",         "biome": "ashlands",      "power": 13, "hp": 68,
     "drops": [("orc_tooth", 0.6), ("iron_ore", 0.5), ("basalt_axe", 0.08)]},
    # lava_caves
    {"id": "fire_drake_whelp",  "name": "Fire-Drake Whelp",  "biome": "lava_caves",    "power": 15, "hp": 78,
     "drops": [("drake_scale", 0.55), ("sulphur_crystal", 0.6), ("skillbook_ember_lash", 0.04)]},
    {"id": "magma_slime",       "name": "Magma Slime",       "biome": "lava_caves",    "power": 12, "hp": 62,
     "drops": [("slime_ichor", 0.7), ("obsidian_chunk", 0.4)]},
    # basalt_steppe
    {"id": "steppe_raptor",     "name": "Steppe Raptor",     "biome": "basalt_steppe", "power": 12, "hp": 58,
     "drops": [("basalt_shard", 0.5), ("wolf_fang", 0.4), ("ashplate", 0.05)]},
    {"id": "orc_warhound",      "name": "Orc Warhound",      "biome": "basalt_steppe", "power": 14, "hp": 72,
     "drops": [("orc_tooth", 0.5), ("boar_hide", 0.5), ("iron_ore", 0.4)]},
    # obsidian_pits
    {"id": "obsidian_wraith",   "name": "Obsidian Wraith",   "biome": "obsidian_pits", "power": 16, "hp": 74,
     "drops": [("wraith_essence", 0.6), ("obsidian_chunk", 0.6), ("relic_shard", 0.2)]},
    {"id": "ash_kobold",        "name": "Ash Kobold",        "biome": "obsidian_pits", "power": 12, "hp": 60,
     "drops": [("coin_purse", 0.6), ("sulphur_crystal", 0.4)]},

    # ================ NYXMOOR (Lv 15+) ================
    # bogland
    {"id": "bog_hag",           "name": "Bog Hag",           "biome": "bogland",       "power": 20, "hp": 100,
     "drops": [("hag_hair", 0.55), ("hex_moss", 0.6), ("skillbook_wraith_ward", 0.05)]},
    {"id": "reed_stalker",      "name": "Reed Stalker",      "biome": "bogland",       "power": 18, "hp": 92,
     "drops": [("black_reed", 0.7), ("serpent_scale", 0.4)]},
    # cursed_ruins
    {"id": "cursed_knight",     "name": "Cursed Knight",     "biome": "cursed_ruins",  "power": 22, "hp": 118,
     "drops": [("cursed_stone", 0.55), ("ghost_iron", 0.35), ("cursed_blade", 0.08)]},
    {"id": "wraith_watcher",    "name": "Wraith Watcher",    "biome": "cursed_ruins",  "power": 19, "hp": 98,
     "drops": [("wraith_lantern", 0.5), ("wraith_essence", 0.5)]},
    # deadwood
    {"id": "dread_treant",      "name": "Dread Treant",      "biome": "deadwood",      "power": 21, "hp": 130,
     "drops": [("oak_log", 0.8), ("hex_moss", 0.6), ("mourncloak", 0.06)]},
    {"id": "black_wolf",        "name": "Black Wolf",        "biome": "deadwood",      "power": 18, "hp": 88,
     "drops": [("wolf_pelt", 0.8), ("wolf_fang", 0.5)]},
    # ghost_road
    {"id": "specter_rider",     "name": "Specter Rider",     "biome": "ghost_road",    "power": 23, "hp": 120,
     "drops": [("wraith_essence", 0.6), ("cursed_stone", 0.5), ("demon_ash", 0.4)]},
    {"id": "chain_wraith",      "name": "Chain Wraith",      "biome": "ghost_road",    "power": 20, "hp": 105,
     "drops": [("wraith_lantern", 0.55), ("relic_shard", 0.35)]},

    # ================ FROSTHELM (Lv 22+) ================
    # frozen_peaks
    {"id": "yeti_prowler",      "name": "Yeti Prowler",      "biome": "frozen_peaks",  "power": 26, "hp": 145,
     "drops": [("yeti_pelt", 0.6), ("frost_root", 0.5)]},
    {"id": "sky_falcon",        "name": "Sky Falcon",        "biome": "frozen_peaks",  "power": 24, "hp": 128,
     "drops": [("silver_vein", 0.5), ("griffon_feather", 0.15)]},
    # glacier
    {"id": "frost_wyrm_kin",    "name": "Frost Wyrm Kin",    "biome": "glacier",       "power": 30, "hp": 175,
     "drops": [("wyrm_scale", 0.65), ("cold_iron", 0.4), ("skillbook_frost_edge", 0.05)]},
    {"id": "ice_wraith",        "name": "Ice Wraith",        "biome": "glacier",       "power": 27, "hp": 152,
     "drops": [("glacier_shard", 0.65), ("wraith_essence", 0.35)]},
    # tundra
    {"id": "tundra_mammoth",    "name": "Tundra Mammoth",    "biome": "tundra",        "power": 32, "hp": 200,
     "drops": [("mammoth_tusk", 0.7), ("boar_hide", 0.8), ("jahra_hauberk", 0.05)]},
    {"id": "snow_wolf_pack",    "name": "Snow Wolf",         "biome": "tundra",        "power": 25, "hp": 132,
     "drops": [("wolf_pelt", 0.9), ("wolf_fang", 0.6), ("frost_root", 0.4)]},
    # ice_caverns
    {"id": "cavern_troll",      "name": "Cavern Troll",      "biome": "ice_caverns",   "power": 31, "hp": 190,
     "drops": [("cold_iron", 0.6), ("glacier_shard", 0.5), ("cold_iron_spear", 0.08)]},
    {"id": "crystal_lurker",    "name": "Crystal Lurker",    "biome": "ice_caverns",   "power": 26, "hp": 148,
     "drops": [("silver_vein", 0.6), ("glacier_shard", 0.5)]},

    # ================ ZEPHYRIA (Lv 30+) ================
    # sky_isles
    {"id": "sky_serpent",       "name": "Sky Serpent",       "biome": "sky_isles",     "power": 35, "hp": 210,
     "drops": [("sky_serpent_hide", 0.6), ("sky_iron", 0.5), ("storm_bow", 0.06)]},
    {"id": "wind_rider",        "name": "Wind Rider",        "biome": "sky_isles",     "power": 32, "hp": 190,
     "drops": [("cloud_silk", 0.55), ("silverleaf", 0.5)]},
    # cloud_forest
    {"id": "griffon",           "name": "Griffon",           "biome": "cloud_forest",  "power": 38, "hp": 235,
     "drops": [("griffon_feather", 0.7), ("wolf_pelt", 0.4), ("skillbook_wind_step", 0.04)]},
    {"id": "silverleaf_dryad",  "name": "Silverleaf Dryad",  "biome": "cloud_forest",  "power": 33, "hp": 200,
     "drops": [("silverleaf", 0.75), ("wild_herb", 0.5)]},
    # storm_plateau
    {"id": "storm_titan_shard", "name": "Storm Titan Shard", "biome": "storm_plateau", "power": 40, "hp": 260,
     "drops": [("storm_glass", 0.65), ("star_shard", 0.25), ("sky_mantle", 0.06)]},
    {"id": "sky_kobold",        "name": "Sky Kobold",        "biome": "storm_plateau", "power": 30, "hp": 175,
     "drops": [("coin_purse", 0.7), ("sky_iron", 0.4)]},
    # celestial_ruins
    {"id": "star_wraith",       "name": "Star Wraith",       "biome": "celestial_ruins","power": 42, "hp": 250,
     "drops": [("star_shard", 0.45), ("wraith_essence", 0.5), ("relic_shard", 0.5)]},
    {"id": "celestial_guardian","name":"Celestial Guardian", "biome": "celestial_ruins","power": 39, "hp": 240,
     "drops": [("sky_iron", 0.65), ("skillbook_thornlash", 0.06)]},

    # ================ SABLEWASTE (Lv 38+) ================
    # dune_sea
    {"id": "dune_worm",         "name": "Dune Worm",         "biome": "dune_sea",      "power": 44, "hp": 280,
     "drops": [("golden_sand", 0.9), ("scarab_shell", 0.4)]},
    {"id": "sand_djinn_lesser", "name": "Sand Djinn (Lesser)","biome":"dune_sea",     "power": 46, "hp": 300,
     "drops": [("djinn_glass", 0.5), ("mirage_silk", 0.3), ("djinn_scimitar", 0.05)]},
    # oasis
    {"id": "oasis_serpent",     "name": "Oasis Serpent",     "biome": "oasis",         "power": 42, "hp": 258,
     "drops": [("serpent_venom", 0.7), ("sun_bloom", 0.6), ("serpent_scale", 0.7)]},
    {"id": "mirage_wolf",       "name": "Mirage Wolf",       "biome": "oasis",         "power": 40, "hp": 240,
     "drops": [("mirage_silk", 0.35), ("wolf_pelt", 0.7)]},
    # djinn_ruins
    {"id": "djinn_guardian",    "name": "Djinn Guardian",    "biome": "djinn_ruins",   "power": 48, "hp": 315,
     "drops": [("djinn_glass", 0.65), ("djinn_bottle_shard", 0.1), ("sunveil_robe", 0.06)]},
    {"id": "sun_priest_wraith", "name": "Sun-Priest Wraith", "biome": "djinn_ruins",   "power": 45, "hp": 292,
     "drops": [("sun_priest_seal", 0.35), ("wraith_essence", 0.5)]},
    # sunken_temple
    {"id": "temple_scarab",     "name": "Temple Scarab",     "biome": "sunken_temple", "power": 43, "hp": 268,
     "drops": [("scarab_shell", 0.8), ("relic_shard", 0.4)]},
    {"id": "sand_ghast",        "name": "Sand Ghast",        "biome": "sunken_temple", "power": 47, "hp": 305,
     "drops": [("ghast_dust", 0.7), ("sun_priest_seal", 0.3), ("skillbook_sunlance", 0.04)]},

    # ================ VERDANIA (Lv 45+) ================
    # rainforest
    {"id": "jungle_stalker",    "name": "Jungle Stalker",    "biome": "rainforest",    "power": 50, "hp": 335,
     "drops": [("emerald_frond", 0.6), ("canopy_venom", 0.4), ("wolf_pelt", 0.5)]},
    {"id": "vine_serpent",      "name": "Vine Serpent",      "biome": "rainforest",    "power": 52, "hp": 348,
     "drops": [("living_wood", 0.45), ("serpent_venom", 0.6), ("canopy_venom", 0.5)]},
    # canopy_boughs
    {"id": "canopy_wyrm",       "name": "Canopy Wyrm",       "biome": "canopy_boughs", "power": 55, "hp": 375,
     "drops": [("living_wood", 0.6), ("sylvan_seed", 0.25), ("sylvan_glaive", 0.05)]},
    {"id": "sylvan_druid_lost", "name": "Lost Sylvan Druid", "biome": "canopy_boughs", "power": 50, "hp": 330,
     "drops": [("emerald_frond", 0.7), ("sylvan_seed", 0.3), ("skillbook_thornlash", 0.08)]},
    # coral_reef
    {"id": "reef_shark",        "name": "Reef Shark",        "biome": "coral_reef",    "power": 53, "hp": 350,
     "drops": [("abyss_coral", 0.55), ("pearl_shell", 0.6), ("serpent_scale", 0.4)]},
    {"id": "coral_construct",   "name": "Coral Construct",   "biome": "coral_reef",    "power": 51, "hp": 345,
     "drops": [("abyss_coral", 0.7), ("pearl_shell", 0.5), ("coral_platemail", 0.05)]},
    # sunken_atlantyrion
    {"id": "kraken_spawn",      "name": "Kraken Spawn",      "biome": "sunken_atlantyrion","power": 58, "hp": 400,
     "drops": [("kraken_ink", 0.55), ("abyss_coral", 0.55), ("skillbook_tidefury", 0.05)]},
    {"id": "tide_priest",       "name": "Tide-Priest",       "biome": "sunken_atlantyrion","power": 55, "hp": 372,
