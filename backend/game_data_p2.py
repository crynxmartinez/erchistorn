...
TOWNS: list[dict] = [
    ...
    },
    {
        ...
        "continent": "aetheria",
        "desc": "A quiet town of white stone and willow trees. The herbalists of Riverguard brew remedies for any ailment.",
...
QUESTS: list[dict] = [
    # ---------- Regional (Aetheria) ----------
    {
        ...
        "brief": "Wolves are terrorizing the outskirts. Oathspire's smiths post a bounty — slay 5 Gray Wolves and return.",
    ...
    },
    {
        ...
        "brief": "Riverguard's healers need herbs. Gather 12 Wild Herbs and deliver them.",
    ...
    # ---------- Story (main storyline) ----------
    {
        ...
        "giver": "master_arden",
        "brief": "Oathspire's Master Arden asks you to prove yourself: slay a Grove Wisp and bring evidence.",
...
EVENTS: list[dict] = [
    ...
    },
    {
        ...
        "kind": "festival",
        "brief": "Oathspire and Riverguard celebrate a founding festival. Craft 5 items and gather 15 materials to earn festival rewards.",
    ...
    },
    {
        ...
        "kind": "bounty",
        "brief": "A standing bounty from Riverguard. Any hero who slays a River Serpent may claim it once per week.",
        "schedule_days": [-1],
...
STATIC_ANNOUNCEMENTS: list[dict] = [
    {
        ...
        "body": "The gates of Valeria are open. Two towns stand ready: Oathspire for the forge, Riverguard for the priest's touch. May your dice be kind.",
    },
    {
        "id": "guilds_open",
        "kind": "system",
