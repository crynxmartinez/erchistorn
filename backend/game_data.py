...
CONTINENTS: list[dict] = [
    ...
    {"id": "vulkaros",    "name": "Vulkaros",    "level_req": 8,
     "desc": "Volcanic ashlands and lava caves. Home to Orc dominions and fire-drakes.", "biomes": []},
    {"id": "nyxmoor",     "name": "Nyxmoor",     "level_req": 15,
     "desc": "Cursed bogs where demons once walked. Wraiths and hags remember.", "biomes": []},
    {"id": "frosthelm",   "name": "Frosthelm",   "level_req": 22,
     "desc": "Tundras and glaciers above the great Dwarven Undermountain.", "biomes": []},
    {"id": "zephyria",    "name": "Zephyria",    "level_req": 30,
     "desc": "Sky islands and storm-peaks — the Higher Enclave of the Elves.", "biomes": []},
    {"id": "sablewaste",  "name": "Sablewaste",  "level_req": 38,
     "desc": "Dunes and ancient ruins where djinn whisper broken bargains.", "biomes": []},
    {"id": "verdania",    "name": "Verdania",    "level_req": 45,
     "desc": "Deep jungle and coral coasts leading to Atlantyrion.", "biomes": []},
]
